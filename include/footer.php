...
if (isset($_SESSION['username'])) {
	...
	if ($_SESSION['nivel'] < 2) {
		echo "<td><center><a href='./customers/index.php'>Customers</a></center></td>\n";
		echo "<td><center><a href='index_parametro.php'>Parameters</a></center></td>\n";
		echo "<td><center><a href='index_normas.php'>Regulations</a></center></td>\n";
	} else {
		echo "<td>&nbsp;</td>\n";
		echo "<td>&nbsp;</td>\n";
		echo "<td>&nbsp;</td>\n";
	...
	echo "<td align='center'><a href='index_formato.php'>Reports</a></td>\n";
